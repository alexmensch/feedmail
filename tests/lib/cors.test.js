...
describe("cors", () => {
  ...
  describe("handleCORSPreflight", () => {
    ...
    it("returns 403 when allowed origins list is empty", () => {
  ...
  describe("withCORS", () => {
    it("adds CORS header to response for allowed origin", () => {
      getAllCorsOrigins.mockReturnValue(["https://example.com"]);
      const request = makeRequest("https://example.com");
      ...
      const response = withCORS(original, request, env);
    ...
    it("returns original response when no Origin header", () => {
      getAllCorsOrigins.mockReturnValue(["https://example.com"]);
      const request = makeRequest(null);
      const original = new Response("test", { status: 200 });
    ...
    it("preserves original response status and statusText", () => {
      getAllCorsOrigins.mockReturnValue(["https://example.com"]);
      const request = makeRequest("https://example.com");
    ...
    it("creates a new Response object (does not mutate original)", () => {
      getAllCorsOrigins.mockReturnValue(["https://example.com"]);
      const request = makeRequest("https://example.com");
      const original = new Response("test", { status: 200 });
