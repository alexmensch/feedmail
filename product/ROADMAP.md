...
| [admin-console-styled](./shipped/admin-console-styled.md)                           | HTMX-powered interactions, CUBE CSS with Every Layout primitives, fluid responsive design, dark mode, auth page styling                                          | `D04F43C0-AF8F-4CDA-B9ED-4E9C1D3ACA1B` |     |
