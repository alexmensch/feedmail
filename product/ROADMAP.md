...
| [admin-rate-limit-bypass](./shipped/admin-rate-limit-bypass.md)                     | Exempts authenticated service binding requests from API Worker rate limiting so active admin console usage is never throttled                                     | `958A5E88-B87B-45D8-991E-3F236EF869A3` |     |
